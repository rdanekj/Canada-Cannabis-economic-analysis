...
SELECT cpl.ref_date, cpl.geo , cpl.dguid , cpl.consumer_price , cpl.Consumer_price_increase  ,cpl.producer_price ,cpl.Producer_price_increase  ,cpl.profit_or_loss,round((cpl.consumer_price/cpl.producer_price),2) as mark_up,
cpi.consumer_price_index , cpi.consumer_end_of_year_price_index_change , cpi.producer_price_index , cpi.producer_end_of_year_price_index_change
FROM
...
-- Join prices with price index provinces
SELECT cpp.ref_date , cpp.geo , cpp.dguid , cpp.consumer_price ,cpp.Consumer_price_increase , 
cpp.producer_price , cpp.Producer_price_increase , cpp.profit_or_loss, round ((cpp.consumer_price/cpp.producer_price),2) as mark_up_percent,
cppi.consumer_price_index , cppi.consumer_end_of_year_price_index_change , cppi.producer_price_index , cppi.producer_end_of_year_price_index_change
FROM 
(SELECT ppc.ref_date , ppc.geo , ppc.dguid , ppc.consumer_price ,ppcg.Consumer_price_increase , 
ppc.producer_price , ppcg.Producer_price_increase , ppc.profit_or_loss 
FROM cannabis_c_p.consumer_producer_prices_cities ppc
...
ON consumer.ref_date = producer.ref_date AND consumer.geo = producer.geo AND consumer.dguid = producer.dguid 
ORDER BY 2,1) cppi
ON cpp.ref_date = cppi.ref_date AND cpp.geo = cppi.geo 
order by 2,1;



-- Creat views for data vizualization
-- province consumer_producer pricees and price index

CREATE VIEW cannabis_c_p.province_cons_prod_price as
SELECT cpp.ref_date , cpp.geo , cpp.dguid , cpp.consumer_price ,cpp.Consumer_price_increase , 
cpp.producer_price , cpp.Producer_price_increase , cpp.profit_or_loss, round ((cpp.consumer_price/cpp.producer_price),2) as mark_up_percent,
cppi.consumer_price_index , cppi.consumer_end_of_year_price_index_change , cppi.producer_price_index , cppi.producer_end_of_year_price_index_change
FROM (SELECT ppc.ref_date , ppc.geo , ppc.dguid , ppc.consumer_price ,ppcg.Consumer_price_increase , 
ppc.producer_price , ppcg.Producer_price_increase , ppc.profit_or_loss 
FROM cannabis_c_p.consumer_producer_prices_cities ppc
Left JOIN 
(SELECT p_l1.ref_date,p_l1.geo,p_l1.dguid, p_l1.consumer_price,round(p_l2.consumer_price-p_l1.consumer_price,2) as Consumer_price_increase,
...
JOIN (SELECT consumer.ref_date, consumer.geo , consumer.dguid , consumer.consumer_price_index , consumer.consumer_end_of_year_price_index_change , producer.producer_price_index , producer.producer_end_of_year_price_index_change
FROM cannabis_c_p.prov_consumer_pi consumer
JOIN cannabis_c_p.prov_producer_pi producer
ON consumer.ref_date = producer.ref_date AND consumer.geo = producer.geo AND consumer.dguid = producer.dguid 
ORDER BY 2,1) cppi
...
CREATE VIEW cannabis_c_p.country_cannabis_price as
SELECT cpl.ref_date, cpl.geo , cpl.dguid , cpl.consumer_price , cpl.Consumer_price_increase  ,cpl.producer_price ,cpl.Producer_price_increase  ,cpl.profit_or_loss,round((cpl.consumer_price/cpl.producer_price),2) as mark_up_percent,
cpi.consumer_price_index , cpi.consumer_end_of_year_price_index_change , cpi.producer_price_index , cpi.producer_end_of_year_price_index_change
FROM
(SELECT pl.ref_date, pl.geo , pl.dguid , pl.consumer_price , cpc.Consumer_price_increase  ,pl.producer_price ,cpc.Producer_price_increase  ,pl.profit_or_loss
FROM cannabis_c_p.profit_loss pl
