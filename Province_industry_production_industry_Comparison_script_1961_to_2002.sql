-- Scripts to look at each indicator and how they performed in each industry comparitavely. comparing similar authorities of  industries 
-- with each other. Unlicesned retail industries vs unlicensed cultivation industries and licensed cultivation industries with retail industries
...
SELECT *
FROM cannabis_c_p.gross_val_added_per_region;
