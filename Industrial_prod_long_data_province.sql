...
Drop table if exists cannabis_c_p.province_indus_cult_lic_value_growth;
CREATE TABLE cannabis_c_p.province_indus_cult_lic_value_growth 
(ref_date int, geo varchar (150), dguid varchar (100), indicator varchar (100), industry varchar (100), 
authority varchar (100),value double, value_growth double);
INSERT INTO cannabis_c_p.province_indus_cult_lic_value_growth
...
FROM cannabis_c_p.`industr_ prod`
Where industry = "Cannabis cultivation industry" AND authority = 'Licensed source' and geo != 'Canada'
Order by 4,3,1) lic_cci1
JOIN
(SELECT ref_date, geo, dguid, indicator, industry, authority,value * 1000000 as value
FROM cannabis_c_p.`industr_ prod`
Where industry = "Cannabis cultivation industry" AND authority = 'Licensed source' and geo != 'Canada'
Order by 4,3,1) lic_cci2
ON lic_cci2.ref_date = lic_cci1.ref_date + 1 and lic_cci1.indicator = lic_cci2.indicator AND lic_cci1.geo = lic_cci2.geo
ORDER BY 4,3,1;
...
FROM cannabis_c_p.`industr_ prod`
Where industry = "Cannabis cultivation industry" AND authority = 'Licensed source' and geo != 'Canada'
Order by 4,3,1) l_cci
LEFT JOIN
cannabis_c_p.province_indus_cult_lic_value_growth l_ccig
on l_ccig.ref_date = l_cci.ref_date and l_cci.indicator = l_ccig.indicator AND l_cci.geo = l_ccig.geo
ORDER BY 4,3,1;
...
Drop table if exists cannabis_c_p.province_cult_indus_unlic_value_growth;
CREATE TABLE cannabis_c_p.province_cult_indus_unlic_value_growth 
(ref_date int, geo varchar (125), dguid varchar (100), indicator varchar (100), industry varchar (100), 
authority varchar (100),value double, value_growth double);
INSERT INTO cannabis_c_p.province_cult_indus_unlic_value_growth
...
FROM cannabis_c_p.`industr_ prod`
Where industry = "Cannabis cultivation industry" AND authority != 'Licensed source' and geo != 'Canada'
Order by 4,3,1) unlic_cci1
JOIN
(SELECT ref_date, geo, dguid, indicator, industry, authority,value * 1000000 as value
FROM cannabis_c_p.`industr_ prod`
Where industry = "Cannabis cultivation industry" AND authority != 'Licensed source' and geo != 'Canada'
Order by 4,3,1) unlic_cci2
ON unlic_cci2.ref_date = unlic_cci1.ref_date + 1 and unlic_cci1.indicator = unlic_cci2.indicator and unlic_cci1.geo = unlic_cci2.geo
ORDER BY 4,3,1;
...
FROM cannabis_c_p.`industr_ prod`
Where industry = "Cannabis cultivation industry" AND authority != 'Licensed source' and geo != 'Canada'
Order by 4,3,1) ul_cci
LEFT JOIN
cannabis_c_p.province_cult_indus_unlic_value_growth ul_ccig
on ul_ccig.ref_date = ul_cci.ref_date and ul_cci.indicator = ul_ccig.indicator and ul_cci.geo = ul_ccig.geo
ORDER BY 4,3,1;
...
Drop table if exists cannabis_c_p.province_indus_retail_lic_value_growth;
CREATE TABLE cannabis_c_p.province_indus_retail_lic_value_growth 
(ref_date int, geo varchar (125), dguid varchar (100), indicator varchar (100), industry varchar (100), 
authority varchar (100),value double, value_growth double);
INSERT INTO cannabis_c_p.province_indus_retail_lic_value_growth
...
FROM cannabis_c_p.`industr_ prod`
Where industry != "Cannabis cultivation industry" AND authority = 'Licensed source' and geo != 'Canada'
Order by 4,3,1) lic_ri1
JOIN
(SELECT ref_date, geo, dguid, indicator, industry, authority,value * 1000000 as value
FROM cannabis_c_p.`industr_ prod`
Where industry != "Cannabis cultivation industry" AND authority = 'Licensed source' and geo != 'Canada'
Order by 4,3,1) lic_ri2
ON lic_ri2.ref_date = lic_ri1.ref_date + 1 and lic_ri1.indicator = lic_ri2.indicator and lic_ri1.geo = lic_ri2.geo
ORDER BY 4,3,1;
...
Order by 4,1)lic_ri
Left JOin
cannabis_c_p.province_indus_retail_lic_value_growth lic_rig
ON lic_rig.ref_date = lic_ri.ref_date and lic_ri.indicator = lic_rig.indicator and lic_ri.geo = lic_rig.geo
ORDER BY 4,3,1;
...
-- This segment of code breaks down the licensed cannabis retail industry and calculates the yearly increase or change in value for each indicator i
Drop table if exists cannabis_c_p.province_indus_retail_unlic_value_growth;
CREATE TABLE cannabis_c_p.province_indus_retail_unlic_value_growth 
(ref_date int, geo varchar (125), dguid varchar (100), indicator varchar (100), industry varchar (100), 
authority varchar (100),value double, value_growth double);
INSERT INTO cannabis_c_p.province_indus_retail_unlic_value_growth
...
FROM cannabis_c_p.`industr_ prod`
Where industry != "Cannabis cultivation industry" AND authority != 'Licensed source' and geo != 'Canada'
Order by 4,3,1) unlic_ri1
JOIN
(SELECT ref_date, geo, dguid, indicator, industry, authority,value * 1000000 as value
FROM cannabis_c_p.`industr_ prod`
Where industry != "Cannabis cultivation industry" AND authority != 'Licensed source' and geo != 'Canada'
Order by 4,3,1) unlic_ri2
ON unlic_ri2.ref_date = unlic_ri1.ref_date + 1 and unlic_ri1.indicator = unlic_ri2.indicator and unlic_ri1.geo = unlic_ri2.geo
ORDER BY 4,3,1;
select * from cannabis_c_p.province_indus_retail_unlic_value_growth ;
...
FROM cannabis_c_p.`industr_ prod`
Where industry != "Cannabis cultivation industry" AND authority != 'Licensed source' and geo != 'Canada'
Order by 4,3,1)unlic_ri
Left JOin
cannabis_c_p.province_indus_retail_unlic_value_growth unlic_rig
ON unlic_rig.ref_date = unlic_ri.ref_date and unlic_ri.indicator = unlic_rig.indicator and unlic_ri.geo = unlic_rig.geo
ORDER BY 4,3,1;
